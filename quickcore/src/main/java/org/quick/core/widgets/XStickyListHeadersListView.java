...
//        int duration = 500;
//        isLoadingMore = true;
//        ObjectAnimator.ofFloat(footerAnimView, "alpha", 1, 0).duration(duration).onAction();
//        objectAnimatorX = ObjectAnimator.ofFloat(footerAnimView, "scaleX", 0, 1).duration(duration);
//        objectAnimatorY = ObjectAnimator.ofFloat(footerAnimView, "scaleY", 0, 1).duration(duration);
//
...
//            }
//        });
//        objectAnimatorX.onAction();
//        objectAnimatorY.onAction();
//    }
//
