...
public class SideBarView extends View {
    ...
    private void init() {
        ...
        sideTextSpac = (int) FormatUtils.INSTANCE.dip2px(getContext(),10);

        sideTextSize = (int) FormatUtils.INSTANCE.dip2px(getContext(),10);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int height = b.size() * (ViewUtils.INSTANCE.getFontHeight(sideTextPaint,"正") + sideTextSpac) + sideTextSpac * 2;
