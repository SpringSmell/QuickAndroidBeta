...
class CompatViewPager : androidx.viewpager.widget.ViewPager {
    ...
    class TransformerFactory {
        ...
        fun getTransformer(viewPager: androidx.viewpager.widget.ViewPager, type: TransformerType): PageTransformer = when (type) {
        ...
        inner class DepthPageTransformer : PageTransformer {
            val MIN_SCALE = 0.75f
        ...
        inner class FlagPageTransformer : PageTransformer {
            private val MIN_SCALE = 0.85f
            private val MIN_ALPHA = 0.5f
            @SuppressLint("NewApi")
            override fun transformPage(view: View, position: Float) {
        ...
        inner class FlymePageTransformer(private val mViewPager: androidx.viewpager.widget.ViewPager) : PageTransformer {
